# Validation Record — nf-core_fetchngs

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_fetchngs`)
...
| Image-name consistency (`sci-nf-fetchngs` / `sci-nf-fetchngs-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/fetchngs at 4-node Ares SLURM:
...
- **8 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=361, see `paper_widget/data/multinode_profile/nf-core_fetchngs/datalife_2026-04-21_4node/`.
