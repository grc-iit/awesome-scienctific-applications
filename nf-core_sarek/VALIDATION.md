# Validation Record — nf-core_sarek

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_sarek`)
...
| Image-name consistency (`sci-nf-sarek` / `sci-nf-sarek-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/sarek at 4-node Ares SLURM:
...
- **22 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=546, see `paper_widget/data/multinode_profile/nf-core_sarek/datalife_2026-04-21_4node/`.
