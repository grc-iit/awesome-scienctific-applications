# Validation Record — nf-core_nascent

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_nascent`)
...
| Image-name consistency (`sci-nf-nascent` / `sci-nf-nascent-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/nascent at 4-node Ares SLURM:
...
- **24 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=481, see `paper_widget/data/multinode_profile/nf-core_nascent/datalife_2026-04-21_4node/`.
