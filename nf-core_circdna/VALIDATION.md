# Validation Record — nf-core_circdna

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_circdna`)
...
| Image-name consistency (`sci-nf-circdna` / `sci-nf-circdna-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/circdna at 4-node Ares SLURM:
...
- **15 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=891, see `paper_widget/data/multinode_profile/nf-core_circdna/datalife_2026-04-21_4node/`.
