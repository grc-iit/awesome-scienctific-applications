# Validation Record — nf-core_rnaseq

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_rnaseq`)
...
| Image-name consistency (`sci-nf-rnaseq` / `sci-nf-rnaseq-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/rnaseq at 4-node Ares SLURM:
...
- **106 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=7195, see `paper_widget/data/multinode_profile/nf-core_rnaseq/datalife_2026-04-21_4node/`.
