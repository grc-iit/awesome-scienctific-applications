# Validation Record — nf-core_genomeqc

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_genomeqc`)
...
| Image-name consistency (`sci-nf-genomeqc` / `sci-nf-genomeqc-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/genomeqc at 4-node Ares SLURM:
...
- **26 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=8, see `paper_widget/data/multinode_profile/nf-core_genomeqc/datalife_2026-04-21_4node/`.
