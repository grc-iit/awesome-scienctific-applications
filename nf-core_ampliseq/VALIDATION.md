# Validation Record — nf-core_ampliseq

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_ampliseq`)
...
| Image-name consistency (`sci-nf-ampliseq` / `sci-nf-ampliseq-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/ampliseq at 4-node Ares SLURM:
...
- **4 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=2005, see `paper_widget/data/multinode_profile/nf-core_ampliseq/datalife_2026-04-21_4node/`.
