# Validation Record — nf-core_detaxizer

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_detaxizer`)
...
| Image-name consistency (`sci-nf-detaxizer` / `sci-nf-detaxizer-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/detaxizer at 4-node Ares SLURM:
...
- **6 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=238, see `paper_widget/data/multinode_profile/nf-core_detaxizer/datalife_2026-04-21_4node/`.
