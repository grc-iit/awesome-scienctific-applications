# Validation Record — nf-core_scnanoseq

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_scnanoseq`)
...
| Image-name consistency (`sci-nf-scnanoseq` / `sci-nf-scnanoseq-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/scnanoseq at 4-node Ares SLURM:
...
- **127 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=7169, see `paper_widget/data/multinode_profile/nf-core_scnanoseq/datalife_2026-04-21_4node/`.
