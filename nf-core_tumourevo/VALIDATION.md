# Validation Record — nf-core_tumourevo

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_tumourevo`)
...
| Image-name consistency (`sci-nf-tumourevo` / `sci-nf-tumourevo-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/tumourevo at 4-node Ares SLURM:
...
- **87 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=464, see `paper_widget/data/multinode_profile/nf-core_tumourevo/datalife_2026-04-21_4node/`.
