# Validation Record — nf-core_pathogensurveillance

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_pathogensurveillance`)
...
| Check | Result |
|---|---|
| `bash -n run_pathogensurveillance.sh` | ✅ |
...
| Image-name consistency (`sci-nf-pathogensurveillance` / `sci-nf-pathogensurveillance-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/pathogensurveillance at 4-node Ares SLURM:
...
- **76 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=911, see `paper_widget/data/multinode_profile/nf-core_pathogensurveillance/datalife_2026-04-21_4node/`.
