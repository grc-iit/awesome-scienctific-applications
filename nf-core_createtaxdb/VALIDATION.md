# Validation Record — nf-core_createtaxdb

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_createtaxdb`)
...
| Image-name consistency (`sci-nf-createtaxdb` / `sci-nf-createtaxdb-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/createtaxdb at 4-node Ares SLURM:
...
- **56 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=7252, see `paper_widget/data/multinode_profile/nf-core_createtaxdb/datalife_2026-04-21_4node/`.
