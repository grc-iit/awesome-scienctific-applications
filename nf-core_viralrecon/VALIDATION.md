# Validation Record — nf-core_viralrecon

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_viralrecon`)
...
| Image-name consistency (`sci-nf-viralrecon` / `sci-nf-viralrecon-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/viralrecon at 4-node Ares SLURM:
...
- **500 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=701, see `paper_widget/data/multinode_profile/nf-core_viralrecon/datalife_2026-04-21_4node/`.
