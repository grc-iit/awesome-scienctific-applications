# Validation Record — nf-core_mag

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_mag`)
...
| Image-name consistency (`sci-nf-mag` / `sci-nf-mag-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/mag at 4-node Ares SLURM:
...
- ELAPSED_SECONDS=1098, see `paper_widget/data/multinode_profile/nf-core_mag/datalife_2026-04-21_4node/`.
