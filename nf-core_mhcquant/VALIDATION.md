# Validation Record — nf-core_mhcquant

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_mhcquant`)
...
| Image-name consistency (`sci-nf-mhcquant` / `sci-nf-mhcquant-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/mhcquant at 4-node Ares SLURM:
...
- **32 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=9, see `paper_widget/data/multinode_profile/nf-core_mhcquant/datalife_2026-04-21_4node/`.
