# Validation Record — nf-core_taxprofiler

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_taxprofiler`)
...
| Image-name consistency (`sci-nf-taxprofiler` / `sci-nf-taxprofiler-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/taxprofiler at 4-node Ares SLURM:
...
- **72 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=634, see `paper_widget/data/multinode_profile/nf-core_taxprofiler/datalife_2026-04-21_4node/`.
