# Validation Record — nf-core_methylseq

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_methylseq`)
...
| Image-name consistency (`sci-nf-methylseq` / `sci-nf-methylseq-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/methylseq at 4-node Ares SLURM:
...
- **82 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=216, see `paper_widget/data/multinode_profile/nf-core_methylseq/datalife_2026-04-21_4node/`.
