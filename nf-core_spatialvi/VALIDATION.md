# Validation Record — nf-core_spatialvi

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_spatialvi`)
...
| Image-name consistency (`sci-nf-spatialvi` / `sci-nf-spatialvi-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/spatialvi at 4-node Ares SLURM:
...
- **34 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=7161, see `paper_widget/data/multinode_profile/nf-core_spatialvi/datalife_2026-04-21_4node/`.
