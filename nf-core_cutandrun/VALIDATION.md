# Validation Record — nf-core_cutandrun

Last updated: 2026-04-29
Host: Ares login node (`/mnt/common/mtang11/hpc_workflows/upload-asa/nf-core_cutandrun`)
...
| Image-name consistency (`sci-nf-cutandrun` / `sci-nf-cutandrun-deploy`) | ✅ |

## Bare-metal multi-node validation (2026-04-28)

nf-core/cutandrun at 4-node Ares SLURM:
...
- **14 blk_trace JSONs captured** under DataLife profiling.
- ELAPSED_SECONDS=797, see `paper_widget/data/multinode_profile/nf-core_cutandrun/datalife_2026-04-21_4node/`.
